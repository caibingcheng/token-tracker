          ...
          <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            ...
            {preview ? (
              <button
                type="button"
                onClick={onExit}
                className="hidden md:block rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-600 shadow-sm hover:bg-gray-50 hover:text-gray-800 active:scale-[0.98] transition-all min-h-[40px]"
              >
                ← Back to Dashboard
              </button>
            ) : (
